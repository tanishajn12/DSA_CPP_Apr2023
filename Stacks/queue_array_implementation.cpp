...
class queue {
    ...
    int f; //to store the array index at which we have performed the last pop operation

    int r; //to store the array index at which we have performed the last push operation
