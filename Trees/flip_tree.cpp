...
TreeNode* buildTree() {
    ...
    //base case
    if(val==-1) {
        //contruct an empty tree and return pointer to its root TreeNode
        return NULL;
    }
    // recursive case
...
bool flipEquiv(TreeNode* root1, TreeNode* root2) {
    ...
    if(root1==NULL && root2==NULL) {
        //tree 1 is empty and tree2 is empty therefore they are flip equivalent
        return true;
    }
    ...
    if(root1->val !=root2->val) {
        //tree 1 and tree 2 cannot be flip equivalent
        return false;
    }
