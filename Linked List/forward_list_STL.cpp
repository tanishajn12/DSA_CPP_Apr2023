...
#include<iostream>
#include<forward_list> //forward list means singly linked list
#include<iterator>
...
int main() {
    ...
    // creates a forward_list of size 3 all with values 1
